...
func (_m *Repositories) File() repositories.FileServices {
	ret := _m.Called()
...
// Repositories_File_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'File'
type Repositories_File_Call struct {
	*mock.Call
}

// File is a helper method to define mock.On call
func (_e *Repositories_Expecter) File() *Repositories_File_Call {
	return &Repositories_File_Call{Call: _e.mock.On("File")}
}

func (_c *Repositories_File_Call) Run(run func()) *Repositories_File_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *Repositories_File_Call) Return(_a0 repositories.FileServices) *Repositories_File_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Repositories_File_Call) RunAndReturn(run func() repositories.FileServices) *Repositories_File_Call {
	_c.Call.Return(run)
	return _c
}

// MergeRequest provides a mock function with given fields:
func (_m *Repositories) MergeRequest() repositories.MergeRequestServices {
	ret := _m.Called()
...
// Repositories_MergeRequest_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'MergeRequest'
type Repositories_MergeRequest_Call struct {
	*mock.Call
}

// MergeRequest is a helper method to define mock.On call
func (_e *Repositories_Expecter) MergeRequest() *Repositories_MergeRequest_Call {
	return &Repositories_MergeRequest_Call{Call: _e.mock.On("MergeRequest")}
}

func (_c *Repositories_MergeRequest_Call) Run(run func()) *Repositories_MergeRequest_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *Repositories_MergeRequest_Call) Return(_a0 repositories.MergeRequestServices) *Repositories_MergeRequest_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Repositories_MergeRequest_Call) RunAndReturn(run func() repositories.MergeRequestServices) *Repositories_MergeRequest_Call {
	_c.Call.Return(run)
	return _c
}
