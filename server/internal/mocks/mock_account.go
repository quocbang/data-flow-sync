...
func (_m *AccountServices) AddOTP(_a0 context.Context, _a1 string, _a2 string) error {
...
// AccountServices_AddOTP_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'AddOTP'
type AccountServices_AddOTP_Call struct {
	*mock.Call
}
...
//   - _a1 string
//   - _a2 string
func (_e *AccountServices_Expecter) AddOTP(_a0 interface{}, _a1 interface{}, _a2 interface{}) *AccountServices_AddOTP_Call {
	return &AccountServices_AddOTP_Call{Call: _e.mock.On("AddOTP", _a0, _a1, _a2)}
}

func (_c *AccountServices_AddOTP_Call) Run(run func(_a0 context.Context, _a1 string, _a2 string)) *AccountServices_AddOTP_Call {
...
func (_c *AccountServices_AddOTP_Call) Return(_a0 error) *AccountServices_AddOTP_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *AccountServices_AddOTP_Call) RunAndReturn(run func(context.Context, string, string) error) *AccountServices_AddOTP_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *AccountServices) DelOTP(_a0 context.Context, _a1 string) error {
	ret := _m.Called(_a0, _a1)
...
// AccountServices_DelOTP_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DelOTP'
type AccountServices_DelOTP_Call struct {
	*mock.Call
}
...
//   - _a0 context.Context
//   - _a1 string
func (_e *AccountServices_Expecter) DelOTP(_a0 interface{}, _a1 interface{}) *AccountServices_DelOTP_Call {
	return &AccountServices_DelOTP_Call{Call: _e.mock.On("DelOTP", _a0, _a1)}
}

func (_c *AccountServices_DelOTP_Call) Run(run func(_a0 context.Context, _a1 string)) *AccountServices_DelOTP_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string))
	})
	return _c
...
func (_c *AccountServices_DelOTP_Call) Return(_a0 error) *AccountServices_DelOTP_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *AccountServices_DelOTP_Call) RunAndReturn(run func(context.Context, string) error) *AccountServices_DelOTP_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *AccountServices) SignUp(_a0 context.Context, _a1 repositories.SignUpAccountRequest) (repositories.SignInReply, error) {
	ret := _m.Called(_a0, _a1)

	var r0 repositories.SignInReply
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, repositories.SignUpAccountRequest) (repositories.SignInReply, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, repositories.SignUpAccountRequest) repositories.SignInReply); ok {
		r0 = rf(_a0, _a1)
	} else {
		r0 = ret.Get(0).(repositories.SignInReply)
	}

	if rf, ok := ret.Get(1).(func(context.Context, repositories.SignUpAccountRequest) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *AccountServices_SignUp_Call) Return(_a0 repositories.SignInReply, _a1 error) *AccountServices_SignUp_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *AccountServices_SignUp_Call) RunAndReturn(run func(context.Context, repositories.SignUpAccountRequest) (repositories.SignInReply, error)) *AccountServices_SignUp_Call {
	_c.Call.Return(run)
	return _c
}
...
// VerifyAccount provides a mock function with given fields: _a0, _a1
func (_m *AccountServices) VerifyAccount(_a0 context.Context, _a1 repositories.VerifyAccountRequest) (repositories.VerifyAccountReply, error) {
	ret := _m.Called(_a0, _a1)

	var r0 repositories.VerifyAccountReply
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, repositories.VerifyAccountRequest) (repositories.VerifyAccountReply, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, repositories.VerifyAccountRequest) repositories.VerifyAccountReply); ok {
		r0 = rf(_a0, _a1)
	} else {
		r0 = ret.Get(0).(repositories.VerifyAccountReply)
	}

	if rf, ok := ret.Get(1).(func(context.Context, repositories.VerifyAccountRequest) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
...
// AccountServices_VerifyAccount_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'VerifyAccount'
type AccountServices_VerifyAccount_Call struct {
	*mock.Call
}

// VerifyAccount is a helper method to define mock.On call
//   - _a0 context.Context
//   - _a1 repositories.VerifyAccountRequest
func (_e *AccountServices_Expecter) VerifyAccount(_a0 interface{}, _a1 interface{}) *AccountServices_VerifyAccount_Call {
	return &AccountServices_VerifyAccount_Call{Call: _e.mock.On("VerifyAccount", _a0, _a1)}
}

func (_c *AccountServices_VerifyAccount_Call) Run(run func(_a0 context.Context, _a1 repositories.VerifyAccountRequest)) *AccountServices_VerifyAccount_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(repositories.VerifyAccountRequest))
	})
	return _c
}

func (_c *AccountServices_VerifyAccount_Call) Return(_a0 repositories.VerifyAccountReply, _a1 error) *AccountServices_VerifyAccount_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *AccountServices_VerifyAccount_Call) RunAndReturn(run func(context.Context, repositories.VerifyAccountRequest) (repositories.VerifyAccountReply, error)) *AccountServices_VerifyAccount_Call {
	_c.Call.Return(run)
	return _c
}
