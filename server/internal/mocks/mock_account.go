...
func (_m *AccountServices) GetOTPByEmail(_a0 context.Context, _a1 string) (string, error) {
	ret := _m.Called(_a0, _a1)
...
// AccountServices_GetOTPByEmail_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetOTPByEmail'
type AccountServices_GetOTPByEmail_Call struct {
	*mock.Call
}
...
//   - _a0 context.Context
//   - _a1 string
func (_e *AccountServices_Expecter) GetOTPByEmail(_a0 interface{}, _a1 interface{}) *AccountServices_GetOTPByEmail_Call {
	return &AccountServices_GetOTPByEmail_Call{Call: _e.mock.On("GetOTPByEmail", _a0, _a1)}
}

func (_c *AccountServices_GetOTPByEmail_Call) Run(run func(_a0 context.Context, _a1 string)) *AccountServices_GetOTPByEmail_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string))
	})
	return _c
...
func (_c *AccountServices_GetOTPByEmail_Call) Return(_a0 string, _a1 error) *AccountServices_GetOTPByEmail_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *AccountServices_GetOTPByEmail_Call) RunAndReturn(run func(context.Context, string) (string, error)) *AccountServices_GetOTPByEmail_Call {
	_c.Call.Return(run)
	return _c
}
