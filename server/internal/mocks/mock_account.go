...
func (_m *AccountServices) SendMail(_a0 context.Context, _a1 string) error {
	ret := _m.Called(_a0, _a1)
...
func (_c *AccountServices_SendMail_Call) Run(run func(_a0 context.Context, _a1 string)) *AccountServices_SendMail_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string))
	})
	return _c
...
func (_c *AccountServices_SendMail_Call) RunAndReturn(run func(context.Context, string) error) *AccountServices_SendMail_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *AccountServices) SignUp(_a0 context.Context, _a1 repositories.CreateAccountRequest) (repositories.SignInReply, error) {
	ret := _m.Called(_a0, _a1)

	var r0 repositories.SignInReply
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, repositories.CreateAccountRequest) (repositories.SignInReply, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, repositories.CreateAccountRequest) repositories.SignInReply); ok {
		r0 = rf(_a0, _a1)
	} else {
		r0 = ret.Get(0).(repositories.SignInReply)
	}

	if rf, ok := ret.Get(1).(func(context.Context, repositories.CreateAccountRequest) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *AccountServices_SignUp_Call) Run(run func(_a0 context.Context, _a1 repositories.CreateAccountRequest)) *AccountServices_SignUp_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *AccountServices_SignUp_Call) RunAndReturn(run func(context.Context, repositories.CreateAccountRequest) (repositories.SignInReply, error)) *AccountServices_SignUp_Call {
	_c.Call.Return(run)
	return _c
}
