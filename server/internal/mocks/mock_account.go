...
// SendMail provides a mock function with given fields: _a0, _a1
func (_m *AccountServices) SendMail(_a0 context.Context, _a1 repositories.SendMailRequest) error {
	ret := _m.Called(_a0, _a1)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, repositories.SendMailRequest) error); ok {
		r0 = rf(_a0, _a1)
	} else {
		r0 = ret.Error(0)
	}
...
// AccountServices_SendMail_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SendMail'
type AccountServices_SendMail_Call struct {
	*mock.Call
}

// SendMail is a helper method to define mock.On call
//   - _a0 context.Context
//   - _a1 repositories.SendMailRequest
func (_e *AccountServices_Expecter) SendMail(_a0 interface{}, _a1 interface{}) *AccountServices_SendMail_Call {
	return &AccountServices_SendMail_Call{Call: _e.mock.On("SendMail", _a0, _a1)}
}

func (_c *AccountServices_SendMail_Call) Run(run func(_a0 context.Context, _a1 repositories.SendMailRequest)) *AccountServices_SendMail_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(repositories.SendMailRequest))
	})
	return _c
}

func (_c *AccountServices_SendMail_Call) Return(_a0 error) *AccountServices_SendMail_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *AccountServices_SendMail_Call) RunAndReturn(run func(context.Context, repositories.SendMailRequest) error) *AccountServices_SendMail_Call {
	_c.Call.Return(run)
	return _c
}
