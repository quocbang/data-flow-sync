...
type VerifyAccountParams struct {
	...
	/*
	  ...
	  In: body
	*/
	AccountVerify VerifyAccountBody
}
...
func (o *VerifyAccountParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body VerifyAccountBody
		if err := route.Consumer.Consume(r.Body, &body); err != nil {
			if err == io.EOF {
				res = append(res, errors.Required("accountVerify", "body", ""))
			} else {
				res = append(res, errors.NewParseError("accountVerify", "body", "", err))
			}
		} else {
