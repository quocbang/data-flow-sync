...
import { Helmet, NavLink, history } from '@umijs/max';
...
const Register: React.FC = () => {
  ...
  const isNicknameExisted = async (userID: string): Promise<boolean> => {
    return false
    // TODO: find another optimize solution.
    if (userID == "") {
      return false
    }
    ...
    <div className={containerClassName}>
      ...
      >
        ...
        >
          ...
          <FormItem>
            <Button style={{ width: '100%' }} loading={registerLoading} type='primary' htmlType='submit'>
              {intl.formatMessage({
                id: 'menu.register',
                defaultMessage: 'Register',
              })}
          ...
          >
            <>
              <NavLink to={"/user/login"}>
                <FormattedMessage id="pages.login.loginMessage" defaultMessage='Already have an account? Sign In' />
              </NavLink>
            </>
          </div>
        </Form>
